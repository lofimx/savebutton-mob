...
The core functionality of Kaya comes from retrieval: looking up old notes, bookmarks, and files. Arbitrary files can be added, but images and PDFs are the most likely formats other than `.url` (bookmarks) and `.md` (notes).
